...
<div class="row">
  <div class="col-lg-12">
   <div class="container box">
			<h1 align="center">Painel Administrativo Cadastro</h1>
			<br />
       </div>
...
<!--MODAL DO FORMULÁRIO DO CADASTRO DO CURSO-->
		...
		<form method="post" id="user_form" enctype="multipart/form-data">
			<div class="modal-content">
				...
				<div class="modal-body">
                    ...
                    <textarea type="text" name="last_name" id="last_name" class="form-control" required></textarea>
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-default"  onclick="curso()"data-dismiss="modal">Close</button>
				</div>
			</div>
		</form>
	</div>
